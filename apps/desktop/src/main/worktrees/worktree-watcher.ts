...
import { git } from "@/main/git/git-exec";
import { repoLayout, type RepoLocation } from "@/main/git/git";
import { resolveProjectCwd } from "@/main/providers/claude-code/projects";
import { IGNORED_DIRS } from "@/main/fs/ignored-dirs";
